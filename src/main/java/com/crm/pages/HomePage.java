...
public class HomePage extends TestBase {
	...
	@CacheLookup // it will store the element in cache memory // webdriver fire event is used to
					// generate logs
	...
	public HomePage DemoLinkVerify() {
		
		Boolean test1 = DemoPageLink.isDisplayed();
